"""
Intro:  GUI application for Hamamatsu camera control.
...
#
    def setup(self):
        ...
        try:
            from hardware.DMDHardware import DmdHardware
            from hardware.pi_stage_HW_test import PIStage
        except:
            pass
        ...
        from modules.CameraMeasurement import HamamatsuMeasurement
